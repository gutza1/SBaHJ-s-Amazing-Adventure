...
public class AssetMap<Value> {
    ...
    private void collect(Node<Value> x, StringBuilder prefix, ResizingArrayQueue<String> queue) {
        if (x == null) return;
    ...
    private void collect(Node<Value> x, StringBuilder prefix, int i, String pattern, ResizingArrayQueue<String> queue) {
        if (x == null) return;
